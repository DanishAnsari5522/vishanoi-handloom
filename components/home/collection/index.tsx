    ...
    return (
        <>
            <div className="my-12 container mx-auto">
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <div style={{ flex: 1, height: '2px', backgroundColor: '#e8c463' }} />
                    <div style={{ margin: '0 300px', fontSize: "28px", fontWeight: '600' }} className='uppercase'>{props.category}</div>
                    <div style={{ flex: 1, height: '2px', backgroundColor: '#e8c463' }} />
                </div>
                        ...
                        >
                            ...
                            <CardBody className="overflow-visible py-2 ">
                                <Image
                                    isZoomed
                                    alt="Card background"
                                    className="object-cover rounded-lg ease-in-out duration-700 delay-500 w-[100%]"
                                    src={item.img}
